<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DigitalMarketing.aspx.cs" Inherits="TheSeven.Pages.DigitalMarketing" %>

<!DOCTYPE html>
<html>
<head runat="server">
    <meta charset="utf-8">
    <title>Techno Extreme | Digital Marketing</title>
    ...
    <div id="page">
        ...
        <section id="top">
            <header> 
            	<div class="container">                                   
                    <!-- logo -->
                    <div id="logo">
                        <a>Digital<strong> Marketing</strong></a>
         			</div>
                    <!-- menu -->
                    <nav class="navmenu">
                        <ul>
        ...
        <section id="home"> 
            <div id="fullwidth_slider" class="flexslider">                                    
                <img src="/images/DigitalMarketing/digimarketing.jpg" alt="" class="slide_bg" />                            
            </div>
        </section>
        <!-- //end home content -->
        <!-- Tab Section -->
        ...
        <section class="page_section">         
            ...
            <header class="head_section center_section">
                <div class="container">
                    <h1>Be among the game-changers</h1>
                    <div class="separator"></div>
                    <p>Get yourself known by marketing yourself through the ways and avoid getting obsolete.</p>
                </div><!-- end .container -->
</header>
            <!-- //section header -->
            ...
            <div class="container">
                <div ></div>
                <h4 style="text-align: center">Be on the map with fully functional marketed products. We market you on the following :</h4>
                <div class="row">
                    <div class="col-md-4 col-sm-4">
                        <div class="icon-banner">
                        	<a>
                                <div class="icon">
                                	<img alt="" src="/images/DigitalMarketing/googladds.png">
                                </div>
                                <h3>Google ads!</h3>
                                <div class="separator"></div>
                            </a>
                    ...
                    <div class="col-md-4 col-sm-4">
                        <div class="icon-banner">
                        	<a>
                                <div class="icon">
                                	<img alt="" src="/images/DigitalMarketing/businessfacebook.png">
                                </div>
                    ...
                    <div class="col-md-4 col-sm-4">
                        <div class="icon-banner">
                        	<a>
                                <div class="icon">
                                	<img alt="" src="/images/DigitalMarketing/twitterbusiness.jpg">
                                </div>
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-4">
                        <div class="icon-banner">
                            <a>
                                <div class="icon">
                                    <img alt="" src="/images/DigitalMarketing/youtubechannel.jpg">
                                </div>
                    ...
                    <div class="col-md-4 col-sm-4">
                        <div class="icon-banner">
                            <a>
                                <div class="icon">
                                    <img alt="" src="/images/DigitalMarketing/linkedinbusiness.png">
                                </div>
                    ...
                    <div class="col-md-4 col-sm-4">
                        <div class="icon-banner">
                            <a>
                                <div class="icon">
                                    <img alt="" src="/images/DigitalMarketing/instagram-business.jpg">
                                </div>
